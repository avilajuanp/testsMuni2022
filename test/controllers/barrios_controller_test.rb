...
class BarriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barrio" do
    assert_difference("Barrio.count") do
      post barrios_url, params: { barrio: { barrioCode: @barrio.barrioCode, name: @barrio.name } }
    end
  ...
  test "should update barrio" do
    patch barrio_url(@barrio), params: { barrio: { barrioCode: @barrio.barrioCode, name: @barrio.name } }
